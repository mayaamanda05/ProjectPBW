                ...
                <form method="post" action="/surat_masuk">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('tanggal_masuk') is-invalid @enderror" id="tanggal_masuk" placeholder="masukkan tanggal masuk surat ex. 31-01-2021"  name="tanggal_masuk" autocomplete="off" value="{{ old('tanggal_masuk')}}">
                        @error('tanggal_masuk')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
