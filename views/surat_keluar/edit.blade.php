...
@section('container')
    <div class="container">
        <div class="row">
            <div class="col-8">    
                <h1 class="mt-3">Update Surat Keluar</h1>
                ...
                <form method="post" action=" /surat_masuk/{{$suratmasuk->id}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('tanggal_keluar') is-invalid @enderror" id="tanggal_keluar" placeholder="Tambahkan tanggal masuk surat"  name="tanggal_keluar" autocomplete="off" value="{{ $suratmasuk->tanggal_keluar }}">
